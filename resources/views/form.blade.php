                                ...
                                <ul style="margin-top: 0px; ">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td class="line_s">
                                                <img alt="Signature"
                                                    src="data:image/jpeg;base64,{{ $parking->pic_4 }}"
                            ...
                            <div class="after-grey-left-below">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <div class="img-1">
                                                <img alt="car" src="data:image/jpeg;base64,{{ $parking->pic_4 }}" width="120" height="43">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="img-1">
                                                <img alt="car" src="data:image/jpeg;base64,{{ $parking->pic_4 }}" width="200" height="43">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
